# Tournament service 
This is the micro service that handles all calls directly associated with the Tournament entity. It contains the standard GET, PUT, POST and delete methods. It also contains different sorts of methods, e.g find a tournament by its id, find a tournament containing a certain string and etc.
